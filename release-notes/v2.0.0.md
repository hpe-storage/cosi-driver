...
* The HPE COSI driver can now be deployed in non-default namespaces. Previously, deployment was limited to the default namespace due to a bug in creating events for COSI API objects.
